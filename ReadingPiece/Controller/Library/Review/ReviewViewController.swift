...
class ReviewViewController: UIViewController {
    ...
    var reviews = [
        Review(thumbnailImage: UIImage(named: "bookCoverImage1")!, bookTitle: "달러구트 꿈 백화점", author: "이미예 - 1", rating: "4.0", reviewText: "달러구트 꿈 백화점은 우리에게 또다른 세상을 보여준다. 우리가 전혀 알지 못했던 사실을 익숙하면서도", date: Date()),
        ...
        Review(thumbnailImage: UIImage(named: "bookCoverImage3")!, bookTitle: "보건교사 안은영", author: "정세랑 - 3", rating: "2.0", reviewText: "예측할 수 없는 존재들과 사건들의 등장으로 나의 상상력을 극대화 시켜주는 책이다. 젤리괴물들의 모습과 안은영이 젤리괴물들을 무기들 등 이미지를 상상하며 즐거웠다. 등장인물들 각각의 캐릭터 또한 두드러져 한 명 한 명의 실제 모습을 상상해보는 것도 재미있었다.", date: Date(timeIntervalSinceNow: 20)),
        ...
        Review(thumbnailImage: UIImage(named: "bookCoverImage5")!, bookTitle: "빌 게이츠, 기후 재앙을 피하는 법", author: "빌 게이츠 - 5", rating: "5.0", reviewText: "탄소 배출을 제로로 갈 수 있는 다양한 길과 여정을 살펴보고 우리가 어떻게 할 수 있는지를 밝히는 책", date: Date(timeIntervalSinceNow: 40))
    ]
